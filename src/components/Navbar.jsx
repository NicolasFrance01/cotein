    ...
    >
      <div className="container mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center">
          <div className="bg-[#181a18] rounded-full px-6 py-2.5 flex items-center gap-6 border border-white/5">
            <a href="#inicio" className="text-[13px] text-white/80 hover:text-white transition-colors">Inicio</a>
            <a href="#nosotros" className="text-[13px] text-white/80 hover:text-white transition-colors">Acerca de Nosotros</a>
            <a href="#servicios" className="text-[13px] text-white/80 hover:text-white transition-colors">Servicios</a>
            <a href="#contacto" className="text-[13px] text-white/80 hover:text-white transition-colors">Contacto</a>
            <a href="#socio" className="text-[13px] text-[#FF6044] hover:text-[#ff4a2b] font-medium transition-colors">Hazte Socio</a>
          </div>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden absolute top-20 left-0 w-full bg-[#050505] border-b border-white/10 px-6 py-6 flex flex-col gap-6">
          <a href="#inicio" className="text-sm text-white/80" onClick={() => setIsOpen(false)}>Inicio</a>
          <a href="#nosotros" className="text-sm text-white/80" onClick={() => setIsOpen(false)}>Acerca de Nosotros</a>
          <a href="#servicios" className="text-sm text-white/80" onClick={() => setIsOpen(false)}>Servicios</a>
          <a href="#contacto" className="text-sm text-white/80" onClick={() => setIsOpen(false)}>Contacto</a>
          <a href="#socio" className="text-sm text-[#FF6044] font-medium" onClick={() => setIsOpen(false)}>Hazte Socio</a>
        </div>
      )}
    </motion.nav>
  );
