          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
              <div className="glass-panel" style={{ padding: "1.5rem" }}>
                <h4 style={{ color: "var(--text-primary)", marginBottom: "0.5rem", fontWeight: 600 }}>Trabajo Colaborativo</h4>
              ...
              <div className="glass-panel" style={{ padding: "1.5rem" }}>
                <h4 style={{ color: "var(--text-primary)", marginBottom: "0.5rem", fontWeight: 600 }}>Capacitación Continua</h4>
              ...
              <div className="glass-panel" style={{ padding: "1.5rem" }}>
                <h4 style={{ color: "var(--text-primary)", marginBottom: "0.5rem", fontWeight: 600 }}>Participación Democrática</h4>
